...
@section('content')
    <section class="core-values">
        <div class="container">
            ...
            <p class="h4 text-justify mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
    ...
    <section class="horizontal-slide">
        <div class="panel">
    ...
    <script>
        ...
        gsap.to(sections, {
            ...
            scrollTrigger: {
                ...
                scrub: true,
                start:'-90px',
                end: () => "+=" + document.querySelector(".horizontal-slide").offsetWidth
            }
        });
    </script>
@endpush
