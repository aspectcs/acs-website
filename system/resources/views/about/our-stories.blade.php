...
@section('content')
    <section class="our-stories">
        <div class="container">
            ...
            <div class="row section-margin">
                ...
                <div class="col-12 col-md-6">
                    <div class="heading mb-3 me-4" aria-hidden="true">
                        <img src="@assets('images/elements/space-doodle2.png')" class="space-doodle2 floating-element" alt="">
                        <p class="headline text-start">Why We Do What We Do</p>
                        <p class="text-justify">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                        </p>
                        <p class="text-justify">
            ...
            <div class="row section-margin">
                ...
                <div class="col-12 col-md-6">
                    <div class="heading mb-3 me-4" aria-hidden="true">
                        <img src="@assets('images/elements/space-doodle5.png')" class="space-doodle5 floating-element" alt="">
                        <p class="headline text-start">The Future of Digital Harvest</p>
                        <p class="text-justify">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                        </p>
                        <p class="text-justify">
    ...
    <section class="container-fluid p-0" id="orbit">
        <div class="contact-us pt-5 pb-5">
            <div class="container ">
                <div class="row">
